...
<head>
    ...
    <!-- Title Page-->
    <title>Add Personnel | Motorsport Team Management</title>
    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Personnel Information</h2>
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="Personnel ID" name="personnel_id" required="required">
                        </div>
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="Superior ID" name="superior_id" required="required">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Birthdate (YYYY-MM-DD)" name="birthdate" required="required">
                        </div>
