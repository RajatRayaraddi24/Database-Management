...
<head>
    ...
    <!-- Title Page-->
    <title>Add Finance Entry | Motorsport Team Management</title>
    ...
    <header>
        <nav>
            ...
            <li><a class="homeblack" href="aloginwel.php">Home</a></li>
                ...
                <li><a class="homered" href="addfinance.php">Add Finance Entry</a></li>
    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Finance Details</h2>
                    <form action="process/addfinprocess.php" method="POST" enctype="multipart/form-data">


                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Transaction ID" name="Transaction_ID" required="required">
                        </div>
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="Amount" name="Amount" required="required">
                        </div>

                        <!-- <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="Current Balance" name="Current_Balance" required="required">
                        </div> //-->

                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Date (YYYY-MM-DD)" name="Date" required="required">
                        </div>
