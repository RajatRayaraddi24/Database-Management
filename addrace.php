...
<head>
    ...
    <!-- Title Page-->
    <title>Add Race | Motorsport Team Management</title>
    ...
    <header>
        <nav>
            ...
            <li><a class="homeblack" href="aloginwel.php">Home</a></li>
                ...
                <li><a class="homered" href="addrace.php">Add Race</a></li>
    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Race Details</h2>
                    <form action="process/addraceprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Race Date (YYYY-MM-DD)" name="Race_Date" required="required">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Track Name" name="Track_Name" required="required">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Predicted Forecast" name="Predicted_Forecast" required="required">
                        </div>
