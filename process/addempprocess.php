...
$sql = "INSERT INTO `personnel`(`firstname`, `lastname`, `personnel_id`, `designation`, `superior_id`, `birthdate`,`age`) VALUES ('$firstname','$lastname','$personnel_id','$designation','$superior_id','$birthdate',NULL)";
